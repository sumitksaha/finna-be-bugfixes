...
<head>
    ...
    <title>Welcome to TakeMyTest : Online Aptitude Center</title>
			...
			<div class="container_block">
				...
				<footer>
					...
					<div id="footer_left" style="font-size:14px;">
						...
						<a href="<?php echo base_url(); ?>index.php/takemytest/contact_us" style="text-decoration:none;color:#4D4D4D;cursor:pointer;"> CONTACT US </a>
						<br />
					...
					<div id="footer_right" style="font-size:14px;">
						...
						<span style="float:right">
							<a href="<?php echo base_url(); ?>index.php/takemytest/terms" style="text-decoration:none;color:#191919;cursor:pointer;"> Terms of Use </a> - 
							<a href="<?php echo base_url(); ?>index.php/takemytest/privecy_policy" style="text-decoration:none;color:#191919;cursor:pointer;"> Privecy Policy </a>
						</span>
					</div>
				</footer>
				<!--[if IE]>
